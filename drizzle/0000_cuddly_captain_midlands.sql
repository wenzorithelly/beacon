...
--> statement-breakpoint
CREATE UNIQUE INDEX `Tag_label_key` ON `Tag` (`label`);--> statement-breakpoint
CREATE TABLE `Edge` (
	`id` text PRIMARY KEY NOT NULL,
...
CREATE TABLE `DbColumn` (
	...
	`name` text NOT NULL,
	`type` text NOT NULL,
	`isPk` numeric DEFAULT false NOT NULL,
	`isFk` numeric DEFAULT false NOT NULL,
	`nullable` numeric DEFAULT true NOT NULL,
	`note` text,
...
CREATE TABLE `CodeFileEdge` (
	...
	`circular` numeric DEFAULT false NOT NULL,
...
CREATE TABLE `Note` (
	...
	`pinned` numeric DEFAULT false NOT NULL,
	`createdAt` numeric DEFAULT (CURRENT_TIMESTAMP) NOT NULL,
	`updatedAt` numeric NOT NULL
);
--> statement-breakpoint
