...
// Intercepts a SOFT navigation to /settings (from the nav pill) and renders it as a modal in the
// @modal slot OVER the board the user was on — the underlying page (children slot) is preserved.
// Closing calls router.back().
