...
// target board is one the <MapTabsShell/> keeps mounted (Roadmap / Columns / Architecture /
// Database — all bounded by curated planning-entity counts, so cheap to hold in memory at once).
...
export type ShellView = "ROADMAP" | "COLUMNS" | "ARCHITECTURE" | "DATABASE";
