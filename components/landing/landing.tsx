      ...
      <header className="fixed inset-x-0 top-0 z-50">
        <div className="mx-auto max-w-6xl px-6">
          ...
          >
            ...
            <nav className="flex items-center gap-4 text-sm w-muted sm:gap-6">
              ...
              <a
                href="https://github.com/wenzorithelly/beacon"
                target="_blank"
                rel="noreferrer"
                className="glass-soft w-hover inline-flex items-center gap-2 rounded-full py-1.5 pl-3 pr-3.5 text-foreground"
                aria-label="Beacon on GitHub"
              >
                <BrandIcon d={GITHUB_ICON_PATH} />
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex flex-col items-center justify-between gap-5 md:flex-row">
            ...
            <nav className="flex items-center gap-6 text-sm w-muted">
              ...
              <a
                href="https://github.com/wenzorithelly/beacon/blob/main/LICENSE"
                target="_blank"
                rel="noreferrer"
